    ...
    <div class="p-6 max-w-2xl mx-auto">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Tambahkan jadwal praktik baru</p>
            </div>
        </div>

        {{-- Form Card --}}
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <form action="{{ route('dokter.jadwal.store') }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <input type="number" id="kuota" name="kuota"
                        value="{{ old('kuota', 10) }}" min="1" max="100"
